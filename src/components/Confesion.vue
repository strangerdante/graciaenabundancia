      ...
      <div class="mask-box">
        <div class="px-4 sm:px-14 lg:px-80 mt-32">
          ...
          <p class="text-lg mb-4 text-white">
            ...
            importante porque proporciona una base doctrinal sólida para la
            enseñanza y la predicación. Ayuda a garantizar la unidad doctrinal
            dentro de la congregación y sirve como una guía para los nuevos
            miembros y visitantes sobre lo que creemos y practicamos.
          </p>
